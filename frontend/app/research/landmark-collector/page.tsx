...
import { Camera, Save, Download, Database } from "lucide-react";
import Link from "next/link";

export default function LandmarkCollectorPage() {
  ...
  useEffect(() => {
    async function initMediaPipe() {
      try {
        ...
        console.error("Landmark collector MediaPipe failed:", err);
      }
    }
    initMediaPipe();
  }, []);
